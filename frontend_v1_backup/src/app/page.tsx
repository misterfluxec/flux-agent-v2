...
export default function LandingPage() {
  ...
  const [chatMessages, setChatMessages] = useState([
    { sender: 'agent', text: '¡Hola! Soy Yanua, tu asistente de VentaCore AI. ¿En qué puedo ayudarte hoy?' }
  ]);
  ...
  const handleChatSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const agentResponses = [
        ...
        'Con VentaCore AI puedes ahorrar hasta 3X comparado con otras soluciones. ¿Te gustaría ver una comparativa?',
  ...
  const features = [
    {
      ...
      description: 'Tu vendedor virtual nunca duerme, nunca se cansa y responde instantáneamente a cualquier hora del día.',
      highlight: 'Respuesta Instantánea'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: 'Cada consulta se convierte en venta. El agente cualifica leads, maneja objeciones y cierra operaciones.',
      highlight: '+300% Conversión'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: 'Costos Predictibles',
      description: 'Olvídate de las facturas sorpresas. Un precio fijo mensual incluye todo, sin recargas ni extras.',
    ...
    },
    {
      ...
      description: 'Tus datos y los de tus clientes nunca abandonan tu infraestructura. Completo control y soberanía.',
      highlight: 'Soberanía Total'
    }
  ];
  ...
  const plans = [
    {
      ...
      price: '45',
      period: '/mes',
      tagline: 'Tu negocio nunca duerme',
      features: [
        '3,000 mensajes / mes',
    ...
    },
    {
      ...
      price: '85',
      period: '/mes',
      tagline: 'Vende por notas de voz',
      features: [
        '7,000 mensajes / mes',
    ...
    },
    {
      ...
      price: '160',
      period: '/mes',
      tagline: 'Automatización Total con Ojos',
      features: [
        '15,000 mensajes / mes',
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">VentaCore AI</span>
            </div>
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="#comparativa" className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Comparativa</a>
              <a href="#pricing" className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Planes</a>
              <a href="#tech" className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Tecnología</a>
            </div>

            <div className="flex items-center gap-4">
              <Link href="/login" className="text-gray-400 hover:text-white transition-colors text-sm font-medium hidden sm:block">Iniciar Sesión</Link>
              <Link href="/register" className="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-purple-500 rounded-full text-sm font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all hover:scale-105">
                🚀 7 Días Gratis
              </Link>
            </div>
          </div>
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        <div className="max-w-6xl mx-auto text-center relative">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 animate-fade-in">
            ...
            <span className="text-sm text-gray-300">Infraestructura Edge Computing disponible</span>
          </div>

          {/* Main Headline */}
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 animate-fade-in-delay">
            <span className="bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
              La IA que no solo responde.
            </span>
            <br />
            <span className="bg-gradient-to-r from-purple-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent">
              Ve, escucha y razona como tú.
            </span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-gray-400 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in-delay-2">
            Olvídate de los bots rígidos y las recargas constantes.
            <br className="hidden md:block" />
            <span className="text-white font-medium">VentaCore es la infraestructura de inteligencia local</span> que automatiza tu atención al 100%.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-3">
            <Link href="/register" className="group px-8 py-4 bg-gradient-to-r from-purple-600 to-purple-500 rounded-xl font-bold text-lg hover:shadow-2xl hover:shadow-purple-500/30 transition-all hover:scale-105 flex items-center justify-center gap-2">
              🚀 Activar mis Super Poderes - 7 Días Gratis
      ...
      <section className="py-20 bg-white/5 border-y border-white/10">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-center text-sm font-semibold tracking-widest text-purple-400 uppercase mb-4">POTENCIA LOCAL DE CLASE MUNDIAL</h2>
          <p className="text-center text-gray-400 mb-12">Las opciones más caras del mercado que puedes evitar</p>
          ...
          <div className="text-center mt-8">
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-green-500/10 border border-green-500/30">
              ...
              <span className="text-green-400 font-medium">Con VentaCore AI: Todo incluido desde $45/mes</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-24 px-6 relative">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-purple-400 text-sm font-semibold tracking-widest uppercase mb-4 block">Características</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Automatiza tu atención
              <br />
              <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">y multiplica tus ventas</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              No es solo un bot. Es tu mejor vendedor digital trabajando 24/7.
            </p>
          </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="p-6 text-purple-400 font-bold bg-purple-500/5">VentaCore AI</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section className="py-24 px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/register" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-cyan-600 rounded-xl font-bold text-lg hover:shadow-2xl hover:shadow-purple-500/30 transition-all hover:scale-105">
            🚀 Crear Cuenta Gratis
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
            </svg>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-6 border-t border-white/5">
            <div className="flex items-center gap-6 text-sm text-gray-500">
              ...
              <Link href="/login" className="hover:text-white transition-colors flex items-center gap-1">Portal</Link>
            </div>
            <div className="text-sm text-gray-500">
              © 2026 VentaCore AI / FluxAgent V2. Todos los derechos reservados.
            </div>
          </div>
        </div>
      </footer>
