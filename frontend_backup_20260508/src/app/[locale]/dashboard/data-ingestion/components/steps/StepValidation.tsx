...
export function StepValidation({ onComplete, onBack }: any) {
  ...
  const handleTest = async () => {
    ...
    if (query.toLowerCase().includes('hola') || query.toLowerCase().includes('quien eres')) {
        ...
        answer = `Basado en los datos indexados: El sistema confirma que la información sobre **"${query}"** ha sido procesada correctamente. El modelo de lenguaje está utilizando los fragmentos vectorizados para generar esta respuesta con alta precisión.`;
    }
          ...
          <div className="relative group">
             ...
             <div className="relative flex gap-2 bg-black/60 border border-gray-800 p-2 rounded-2xl">
                <input 
                  ...
                  placeholder="Ej: ¿Cuál es el precio de las zapatillas pro?" 
