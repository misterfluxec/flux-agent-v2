...
export default function ChatPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto flex flex-col h-[calc(100dvh-7rem)] animate-in fade-in duration-700 relative">
          ...
          <div className="h-full flex flex-col items-center justify-center gap-4 text-center">
            ...
            <div>
              ...
              <p className="text-sm mt-2 text-white/40 font-light max-w-sm">
                Hazme una pregunta sobre los productos indexados en tu base de datos para probar el RAG.
              </p>
            </div>
          </div>
        )}
      ...
      {/* ── Input bar ── */}
      <div className="shrink-0 px-6 py-4 flex gap-4 items-center bg-black/40 backdrop-blur-xl border border-white/5 rounded-b-[24px] shadow-xl">
        <Input
          id="chat-input"
          value={input}
          onChange={(e) => setInput(e.target.value)}
          onKeyDown={handleKeyDown}
          placeholder="Escribe tu pregunta para probar el agente..."
          disabled={loading}
