  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] p-6 md:p-8 animate-in fade-in duration-700 relative">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-black/60 backdrop-blur-2xl border border-gray-800/80 rounded-[2rem] p-6 md:p-10 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden">
